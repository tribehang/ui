<template>
  <div id="app">
      <div class="head-One fix-row" v-if="this.$route.name !== 'Home'">
        <div class="container">
          <div class="col-xs-2">
      ...
      <div class="head-Two fix-row" v-if="this.$route.name !== 'Home'">
        <div class="container">
      ...
      <div class="head-Three fix-row" v-if="this.$route.name !== 'Home'">
        <div class="container">
          <div class="col-xs-10">
            <div class="main-menu">
              <nav class="navbar navbar-default">
